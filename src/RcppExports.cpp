...
Rcpp::List Logistic_FAR_Solver_Core(const Eigen::VectorXd& y_vec, const Eigen::MatrixXd& x_mat, const int& h, const int& kn, const int& p, const char& p_type, const Eigen::VectorXd& p_param, const double& mu2, const double& a, const Eigen::VectorXd& bj_vec, const double& tol, const int& max_iter, const Eigen::MatrixXd& h_inv, const Eigen::VectorXd& relax_vec, const Eigen::VectorXd& delta_init, const Eigen::VectorXd& eta_stack_init, const Eigen::VectorXd& mu1_init);
RcppExport SEXP _LogisticFAR_Logistic_FAR_Solver_Core(SEXP y_vecSEXP, SEXP x_matSEXP, SEXP hSEXP, SEXP knSEXP, SEXP pSEXP, SEXP p_typeSEXP, SEXP p_paramSEXP, SEXP mu2SEXP, SEXP aSEXP, SEXP bj_vecSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP h_invSEXP, SEXP relax_vecSEXP, SEXP delta_initSEXP, SEXP eta_stack_initSEXP, SEXP mu1_initSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::MatrixXd& >::type h_inv(h_invSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(Logistic_FAR_Solver_Core(y_vec, x_mat, h, kn, p, p_type, p_param, mu2, a, bj_vec, tol, max_iter, h_inv, relax_vec, delta_init, eta_stack_init, mu1_init));
    return rcpp_result_gen;
END_RCPP
}
// Logistic_FAR_Path_Core
Rcpp::List Logistic_FAR_Path_Core(const Eigen::VectorXd& y_vec, const Eigen::MatrixXd& x_mat, const int& h, const int& kn, const int& p, const char& p_type, Eigen::VectorXd& p_param, const double& mu2, const double& a, const Eigen::VectorXd& bj_vec, const double& tol, const int& max_iter, const Eigen::MatrixXd& h_inv, const Eigen::VectorXd& relax_vec, const Eigen::VectorXd& delta_init, const Eigen::VectorXd& eta_stack_init, const Eigen::VectorXd& mu1_init, const Eigen::VectorXd& lambda_seq);
RcppExport SEXP _LogisticFAR_Logistic_FAR_Path_Core(SEXP y_vecSEXP, SEXP x_matSEXP, SEXP hSEXP, SEXP knSEXP, SEXP pSEXP, SEXP p_typeSEXP, SEXP p_paramSEXP, SEXP mu2SEXP, SEXP aSEXP, SEXP bj_vecSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP h_invSEXP, SEXP relax_vecSEXP, SEXP delta_initSEXP, SEXP eta_stack_initSEXP, SEXP mu1_initSEXP, SEXP lambda_seqSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type y_vec(y_vecSEXP);
    ...
    Rcpp::traits::input_parameter< const int& >::type p(pSEXP);
    Rcpp::traits::input_parameter< const char& >::type p_type(p_typeSEXP);
    Rcpp::traits::input_parameter< Eigen::VectorXd& >::type p_param(p_paramSEXP);
    Rcpp::traits::input_parameter< const double& >::type mu2(mu2SEXP);
    Rcpp::traits::input_parameter< const double& >::type a(aSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type bj_vec(bj_vecSEXP);
    Rcpp::traits::input_parameter< const double& >::type tol(tolSEXP);
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type eta_stack_init(eta_stack_initSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type mu1_init(mu1_initSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type lambda_seq(lambda_seqSEXP);
    rcpp_result_gen = Rcpp::wrap(Logistic_FAR_Path_Core(y_vec, x_mat, h, kn, p, p_type, p_param, mu2, a, bj_vec, tol, max_iter, h_inv, relax_vec, delta_init, eta_stack_init, mu1_init, lambda_seq));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    {"_LogisticFAR_Logistic_FAR_Solver_Core", (DL_FUNC) &_LogisticFAR_Logistic_FAR_Solver_Core, 17},
    {"_LogisticFAR_Logistic_FAR_Path_Core", (DL_FUNC) &_LogisticFAR_Logistic_FAR_Path_Core, 18},
