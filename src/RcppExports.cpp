...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Logistic_FAR_FLiRTI_Solver_Core(y_vec, x_mat, h, kn, p, p_type, p_param, mu2, a, bj_vec, cj_vec, rj_vec, weight_vec, logit_weight_vec, tol, max_iter, relax_vec, hd_mat, hd_inv, delta_init, eta_stack_init, mu1_init));
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type eta_stack_init(eta_stack_initSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type mu1_init(mu1_initSEXP);
    rcpp_result_gen = Rcpp::wrap(Logistic_FAR_Ortho_Solver_Core(y_vec, x_mat, h, kn, p, p_type, p_param, mu2, a, bj_vec, cj_vec, rj_vec, weight_vec, logit_weight_vec, tol, max_iter, relax_vec, t_mat_stack, svd_vec_stack, start_id_vec, hd_mat, hd_inv, delta_init, eta_stack_init, mu1_init));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type eta_stack_init(eta_stack_initSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXd& >::type mu1_init(mu1_initSEXP);
    rcpp_result_gen = Rcpp::wrap(Logistic_FAR_Solver_Core(y_vec, x_mat, h, kn, p, p_type, p_param, mu2, a, bj_vec, cj_vec, rj_vec, weight_vec, logit_weight_vec, tol, max_iter, relax_vec, hd_mat, hd_inv, delta_init, eta_stack_init, mu1_init));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_LogisticFAR_Logistic_FAR_FLiRTI_Solver_Core", (DL_FUNC) &_LogisticFAR_Logistic_FAR_FLiRTI_Solver_Core, 22},
    {"_LogisticFAR_Logistic_FAR_Ortho_Solver_Core", (DL_FUNC) &_LogisticFAR_Logistic_FAR_Ortho_Solver_Core, 25},
    {"_LogisticFAR_Logistic_FAR_Solver_Core", (DL_FUNC) &_LogisticFAR_Logistic_FAR_Solver_Core, 22},
    {NULL, NULL, 0}
};
