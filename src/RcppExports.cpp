...
RcppExport SEXP _LogisticFAR_Logistic_FAR_FLiRTI_Solver_Core(SEXP y_vecSEXP, SEXP x_matSEXP, SEXP hSEXP, SEXP knSEXP, SEXP pSEXP, SEXP p_typeSEXP, SEXP p_paramSEXP, SEXP mu2SEXP, SEXP aSEXP, SEXP bj_vecSEXP, SEXP cj_vecSEXP, SEXP rj_vecSEXP, SEXP tolSEXP, SEXP max_iterSEXP, SEXP relax_vecSEXP, SEXP hd_matSEXP, SEXP hd_invSEXP, SEXP delta_initSEXP, SEXP eta_stack_initSEXP, SEXP mu1_initSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(Logistic_FAR_FLiRTI_Solver_Core(y_vec, x_mat, h, kn, p, p_type, p_param, mu2, a, bj_vec, cj_vec, rj_vec, tol, max_iter, relax_vec, hd_mat, hd_inv, delta_init, eta_stack_init, mu1_init));
...
static const R_CallMethodDef CallEntries[] = {
    {"_LogisticFAR_Logistic_FAR_FLiRTI_Solver_Core", (DL_FUNC) &_LogisticFAR_Logistic_FAR_FLiRTI_Solver_Core, 20},
